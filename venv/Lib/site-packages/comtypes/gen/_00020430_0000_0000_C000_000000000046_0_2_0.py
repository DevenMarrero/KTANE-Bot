...
IFontDisp = Font
__all__ = [ 'Monochrome', 'OLE_XPOS_HIMETRIC', 'FONTSIZE',
           'OLE_COLOR', 'Gray', 'Color', 'OLE_XSIZE_CONTAINER',
           'Unchecked', 'Font', 'StdPicture', 'OLE_CANCELBOOL',
           'FONTSTRIKETHROUGH', 'OLE_XPOS_CONTAINER',
           'OLE_YPOS_PIXELS', 'OLE_YPOS_HIMETRIC', 'OLE_YSIZE_PIXELS',
           'OLE_TRISTATE', 'OLE_XSIZE_HIMETRIC', 'Default',
           'OLE_OPTEXCLUSIVE', 'FONTITALIC', 'OLE_YSIZE_HIMETRIC',
           'IPictureDisp', 'FONTBOLD', 'IFontEventsDisp',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YSIZE_CONTAINER', 'IFont',
           'OLE_XSIZE_PIXELS', 'OLE_XPOS_PIXELS', 'Picture',
           'OLE_YPOS_CONTAINER', 'FontEvents', 'Checked',
           'FONTUNDERSCORE', 'VgaColor', 'FONTNAME',
           'LoadPictureConstants', 'OLE_HANDLE', 'StdFont',
           'IFontDisp', 'IPicture']
